%{?scl:%scl_package geronimo-annotation}
%{!?scl:%global pkg_name %{name}}

Name:           %{?scl_prefix}geronimo-annotation
Version:        1.0
Release:        24.1%{?dist}
...
Source0:        http://repo2.maven.org/maven2/org/apache/geronimo/specs/%{pkg_name}_1.3_spec/%{version}/%{pkg_name}_1.3_spec-%{version}-source-release.zip
...
%prep
%setup -q -n %{pkg_name}_1.3_spec-%{version}
...
%changelog
* Tue Sep  3 2019 Java Maintainers <java-maint@redhat.com> - 1.0-24.1
